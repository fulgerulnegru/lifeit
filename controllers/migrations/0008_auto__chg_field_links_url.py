...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Links.url'
        db.alter_column('controllers_links', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Links.url'
        db.alter_column('controllers_links', 'url', self.gf('django.db.models.fields.URLField')(default=0, max_length=200, unique=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 10, 8, 17, 53, 653481, )'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 10, 8, 17, 53, 653287, )'}),
