...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Newslatter', fields ['email']
        db.create_unique('controllers_newslatter', ['email'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Newslatter', fields ['email']
        db.delete_unique('controllers_newslatter', ['email'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 16, 41, 48, 917334, )'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 16, 41, 48, 917203, )'}),
